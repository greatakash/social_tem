                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        ...
                        <div id="login" class="animate form">
                            <form action="log.php" autocomplete="on" method="post"> 
                                <h1>Log in </h1>
                                ...
                                <p> 
                                    ...
                                    <input id="username" name="user" required="required" type="text" placeholder="myusername or name"/>
                                </p>
                                <p> 
                        ...
                        <div id="register" class="animate form">
                            <form  action="signup.php" autocomplete="on" method="post"> 
                                ...
                                <p> 
                                    ...
                                    <input id="passwordsignup_confirm" name="rpass" required="required" type="password" placeholder="eg. X8df!90EO"/>
                                </p>
