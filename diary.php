  ...
  <div class="main_resize">
    ...
    <div class="content">
      <div class="content_bg">
        <div class="mainbar">
          <div class="article">
            <h2><span><font size="10px" color="black">Diary</font></span></h2>
					<div class="diary">
					<div id="time">
					<?php 
					$my_t=getdate(date("U"));
					...
					<li><a href="Show.php">Read Your Diary</a></li></nav>
					

					<hr>
					<form name="hh" action="save.php">
        ...
        <div class="sidebar">
          <div class="gadget">
            ...
            <ul class="sb_menu">
              ...
              <li class="active"><a href="diarysystem.php">Diary</a></li>
              <li><a href="inbox.php">Inbox</a></li>
              <li><a href="#">Blog</a></li>
